...
if (isset($_POST['email'])) {
    ...
    $email_to = "vake08@gmail.com";
    $email_subject = "Formulario de Contacto - Instituto ICEP";
    $email_from = "vake08@gmail.com";
...
<body>
    <script>
        ...
        window.location = 'http://https://instituto-icep.vercel.app/';
    </script>
</body>
